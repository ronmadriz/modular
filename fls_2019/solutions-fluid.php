	...
	while (have_rows('image_callout')) {
		...
		if (have_rows('callout')) {
			...
			while (have_rows('callout')) {
				...
				$callout_link_url = $callout_link['url'];
				echo '<div class="img col-12 col-md-6">'.PHP_EOL;
				echo '<a href="'.esc_url($callout_link_url).'"><img src="'.$callout_image['url'].'" alt="" class="img-fluid"></a>'.PHP_EOL;
				echo '<div class="content text-center text-md-left">'.PHP_EOL;
				echo '<h3><a href="'.esc_url($callout_link_url).'">'.$callout_title.'</a></h3>'.PHP_EOL;

	...
	while (have_rows('image_callout')) {
		...
		if (have_rows('callout')) {
			while (have_rows('callout')) {
				...
				echo (!empty($callout_image)?'<div class="img col-12 col-md-4"><img src="'.$callout_image['url'].'" class="img-fluid"></div><div class="content col-12 col-md-8">'.PHP_EOL:'<div class="content col-12">');

<?php
/*
Template Name: Narrow Page Layout (New)
...
if ($industry_gallery) {
	...
	echo '<div id="gallery_img" class="row justify-content-center mb-md-3"><div class="col-12 col-md-8 text-md-center"><img src="'.$gallery_img['url'].'" alt="'.$gallery_img['alt'].'" class="img-fluid"></div></div>'.PHP_EOL;
	endif;

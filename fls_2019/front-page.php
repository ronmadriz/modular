...
if ($feat_industries) {
	...
	echo '<div class="caption text-center text-md-left">'.PHP_EOL;
	echo '<h2>'.$feat_ind_title.'</h2>'.PHP_EOL;
	echo '<span class="desc d-none d-sm-block">'.$feat_ind_content.'</span>'.PHP_EOL;

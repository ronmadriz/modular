...
if ($careers_query) {
	...
	echo '<a class="btn btn-primary" data-toggle="collapse" href="#position_'.$count.'" role="button" aria-expanded="false" aria-controls="position_'.$count.'">'.get_the_title().'</a>'.PHP_EOL;

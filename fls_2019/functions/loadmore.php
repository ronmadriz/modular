...
function misha_loadmore_ajax_handler() {
	...
	if (have_posts()) {
		while (have_posts()) {
			...
			echo (!empty($blog__thumb_more)?'<span class="blog__thumb"><img alt="'.get_the_title().'" class="blog__thumb--img" src="'.$blog__thumb_more.'"></span>'.PHP_EOL:'<span class="blog__thumb"/>');

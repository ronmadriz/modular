...
echo '<div class="col-12 col-md-8">Talk to Fall Protection Expert Now <a href="tel:'.$phone.'" rel="noopener noreferrer"><i class="im im-phone"></i> '.$phone.'</a></div>'.PHP_EOL;
echo '</div>'.PHP_EOL;
echo '</div>'.PHP_EOL;
...
echo '<p><strong>Email</strong>: <a href="mailto:'.$email.'?subject=Question from FLS Fall Arrest" rel="noopener noreferrer">'.$email.'</a></p>'.PHP_EOL;
echo '</div>'.PHP_EOL;
echo '</div>'.PHP_EOL;
echo '</div>'.PHP_EOL;
echo '</section>'.PHP_EOL;

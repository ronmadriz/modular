...
function enqueue_my_scripts() {
	...
	if (is_singular('solutions')) {
		...
		wp_enqueue_script('lightgallery_js', 'https://cdnjs.cloudflare.com/ajax/libs/lightgallery/1.3.2/js/lightgallery.js', array('jquery'), '', true, true);
	}
}
...
function enqueue_my_styles() {
	...
	if (is_singular('solutions')) {
		...
		wp_enqueue_style('lightgallery_css', 'https://cdnjs.cloudflare.com/ajax/libs/lightgallery/1.3.2/css/lightgallery.css');
	}

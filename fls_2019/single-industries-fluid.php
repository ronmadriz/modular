...
if (have_rows('contact_form_cta')) {
	while (have_rows('contact_form_cta')) {
		...
		echo (!empty($cfcta_img)?'<div id="cfCTA_Img" class="d-md-flex justify-content-center align-items-md-end col-12 col-md-6"><img src="'.$cfcta_img['url'].'" alt="" class="img-fluid d-md-none"></div>':'').PHP_EOL;

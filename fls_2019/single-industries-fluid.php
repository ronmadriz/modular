...
if ($industry_gallery) {
	...
	echo '<div class="row align-items-center"><div class="col-12 col-md-8 text-md-center"><img src="'.$gallery_img['url'].'" alt="'.$gallery_img['alt'].'"></div></div>'.PHP_EOL;
	endif;
...
if (have_rows('icon_row')) {
	if (have_rows('icon_row')) {
		...
		while (have_rows('icon_row')) {
			...
			echo '<div class="fl_thumb col-3 col-md-2 text-md-center"><img src="'.$fl_image['url'].'" class="img-fluid" alt=""></div>'.PHP_EOL;

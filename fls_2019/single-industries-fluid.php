...
if (have_rows('icon_row')) {
	if (have_rows('icon_row')) {
		...
		while (have_rows('icon_row')) {
			...
			echo '<div class="fl_thumb col-12 col-md-2"><img src="'.$fl_image['url'].'" class="img-fluid" alt=""></div>'.PHP_EOL;
			echo '<div class="fl_content col-12 col-md-10">'.$fl_content.'</div>'.PHP_EOL;
			echo '</div>'.PHP_EOL;
		}
		echo '</div>'.PHP_EOL;
		echo '</section>'.PHP_EOL;

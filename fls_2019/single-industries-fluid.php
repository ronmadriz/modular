...
if (have_rows('contact_form_cta')) {
	while (have_rows('contact_form_cta')) {
		...
		echo '<style>section#contactFormCTA {background-image: url("'.(!empty($cfcta_img)?$cfcta_img['url']:'https://sandbox.fall-arrest.com/wp-content/uploads/2020/01/contactFormCta.jpg').'");}</style>'.PHP_EOL;

...
echo '<section id="cta_blue"><div class="container-fluid"><div class="row"><div class="col-12"><h1 class="text-center"><a href="#cf_contactFormTitle" class="text-center">Speak with a fall protection specialist</a></div></div></div></section>'.PHP_EOL;

...
if (have_rows('contact_form_cta')) {
	while (have_rows('contact_form_cta')) {
		...
		echo '<style>section#contactFormCTA {background-image: url(https://sandbox.fall-arrest.com/wp-content/uploads/2020/01/staff-at-desk-michael.jpg);}</style>'.PHP_EOL;

...
echo '<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=yes" />'.PHP_EOL;
...
echo '</span>'.PHP_EOL;
echo '</button>'.PHP_EOL;
echo '<button id="searchToggle"><i class="fas fa-search"></i></button>'.PHP_EOL;
get_search_form();
echo '</div>'.PHP_EOL;

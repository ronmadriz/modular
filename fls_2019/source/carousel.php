...
if ($solutions_gallery['gallery_pics']) {
	while (have_rows('solutions_gallery')) {
		...
		if ($gallery_pics) {
			...
			$gall_count = 0;
			echo '</div>';
			echo '<a class="carousel-control left" href="#flsCarousel" data-slide="prev"><i class="im im-angle-left"></i></a>'.PHP_EOL;
			echo '<a class="carousel-control right" href="#flsCarousel" data-slide="next"><i class="im im-angle-right"></i></a>'.PHP_EOL;
			echo '</div>';
		}
		$gallery_photos = get_sub_field('gallery_pics');
		if ($gallery_photos) {

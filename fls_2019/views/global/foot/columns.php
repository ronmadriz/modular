...
echo '<ul id="%1$s" class="%2$s">'.PHP_EOL;
...
echo '<li class="footer__item"><strong>Phone:</strong> '.$fax.'</li><li><strong>Fax:</strong> '.$fax.'</li><li class="footer__item"><strong>Email:</strong> <a class="footer__email" href="mailto:'.$email.'?Subject=Information Email from Website Footer">'.$email.'</a></li>'.PHP_EOL;
echo '</ul></li>'.PHP_EOL;

	...
	while (have_rows('hm_ind')) {
		...
		if (have_rows('hm_ind_list')) {
			...
			while (have_rows('hm_ind_list')) {
				...
				echo '<img alt="'.esc_url($hm_ind_industry).'" class="industries__image" src="'.$hm_ind_image['url'].'">'.PHP_EOL;
				echo '<a class="industries__link" href="'.esc_url($hm_ind_industry).'">'.PHP_EOL;
				echo '<span class="industries__link--text">'.esc_html($hm_ind_industry).'</span>'.PHP_EOL;
				echo '</a>'.PHP_EOL;
				echo '</li>'.PHP_EOL;
			}
			echo '</ul>'.PHP_EOL;

...
echo '<span class="hero__holder">'.($banner_img != null?'<img alt="'.$banner_img['alt'].'" class="hero__img" src="'.$banner_img['url'].'">':'').'</span>'.PHP_EOL;
...
echo '</div>'.PHP_EOL;
echo '</div>'.PHP_EOL;
echo do_shortcode("[rev_slider alias="basic-hero-collection1"]").PHP_EOL;

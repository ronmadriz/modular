...
if ($featured_query->have_posts()) {
	...
	echo '<a class="featured__nav featured__nav--prev"><i class="featured__nav--icon"></i><span class="feature__nav--text">'.PHP_EOL;
	_e('Previous', 'fc_core');
	echo '</span></a>'.PHP_EOL;
	echo '<a class="featured__nav featured__nav--next"><i class="featured__nav--icon"></i><span class="feature__nav--text">'.PHP_EOL;
	_e('Next', 'fc_core');
	echo '</span></a>'.PHP_EOL;

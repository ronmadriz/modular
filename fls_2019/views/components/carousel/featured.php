...
if ($featured_query->have_posts()) {
	...
	while ($featured_query->have_posts()) {
		...
		echo '<a class="featured__nav--prev"><i class="featured__nav--icon"></i><span class="feature__nav--text"></span></a>'.PHP_EOL;
		echo '<a class="featured__nav--next"><i class="featured__nav--icon"></i><span class="feature__nav--text"></span></a>'.PHP_EOL;

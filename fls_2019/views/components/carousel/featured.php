...
if ($featured_query->have_posts()) {
	...
	echo '<a class="featured__nav featured__prev"><i class="featured__icon featured__icon--prev"></i><span class="feature__nav--text">'.PHP_EOL;
	_e('Previous', 'fc_core');
	echo '</span></a>'.PHP_EOL;
	echo '<a class="featured__nav featured__next"><i class="featured__icon featured__icon--next"></i><span class="feature__nav--text">'.PHP_EOL;
	_e('Next', 'fc_core');
	echo '</span></a>'.PHP_EOL;

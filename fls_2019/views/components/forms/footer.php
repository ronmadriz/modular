...
echo '<div class="genForm__footer"><div class="wrapper">';
_e('Talk to Fall Protection Expert Now', 'fc_core');
echo '<a class="genForm__footer--link" href="tel:'.$form_phone.'" rel="noopener noreferrer"><i class="im im-phone genForm__footer--icon"></i> '.$form_phone.'</a></div></div>'.PHP_EOL;
